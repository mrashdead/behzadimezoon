  ...
  r("cells()", function (g, e, m) {
    ...
    (V.defaults = {
      ...
      oLanguage: {
        ...
        entries: { _: "", 1: "" },
        lengthLabels: { "-1": "All" },
        sEmptyTable: "هیچ اطلاعاتی در جدول وجود ندارد",
        sInfo: "نمایش _START_ تا _END_ از _TOTAL_ _ENTRIES-TOTAL_",
        sInfoEmpty: "نمایش 0 تا 0 از 0 _ENTRIES-TOTAL_",
        sInfoFiltered: "(پیدا شده از _MAX_تا _ENTRIES-MAX_)",
        sInfoPostFix: "",
        sDecimal: "",
        sThousands: ",",
        sLengthMenu: "_MENU_ _ENTRIES_ در هرصفحه",
        sLoadingRecords: "درحال بارگیری...",
        sProcessing: "",
        sSearch: "Search:",
        sSearchPlaceholder: "",
        sUrl: "",
        sZeroRecords: "هیچ اطلاعاتی پیدا نشده",
      },
      orderDescReverse: !0,
